...
public class CrystalModel extends SinglePartEntityModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData rotor_jodie = modelPartData.addChild("rotor_jodie", ModelPartBuilder.create().uv(110, 2).cuboid(-4.5847F, -10.9613F, -7.514F, 9.0F, 23.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(119, 69).cuboid(-4.0847F, -18.9613F, -7.148F, 8.0F, 12.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(100, 98).cuboid(-3.5847F, -22.9613F, -6.982F, 7.0F, 7.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData cube_r1 = rotor_jodie.addChild("cube_r1", ModelPartBuilder.create().uv(74, 102).cuboid(-3.0F, -7.001F, -6.6469F, 6.0F, 5.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(130, 48).cuboid(-5.0F, -6.999F, -6.0531F, 10.0F, 0.0F, 10.0F, new Dilation(0.001F))
                .uv(62, 126).cuboid(-3.0F, -7.001F, -6.2469F, 6.0F, 5.0F, 1.0F, new Dilation(0.002F))
                .uv(100, 98).cuboid(-3.5F, -5.001F, -6.9129F, 7.0F, 7.0F, 1.0F, new Dilation(0.0F))
                .uv(119, 69).cuboid(-4.0F, -1.001F, -7.0789F, 8.0F, 12.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.0847F, 17.0397F, -0.0691F, 3.1416F, 0.0F, 0.0F));
        ...
        ModelPartData cube_r2 = rotor_jodie.addChild("cube_r2", ModelPartBuilder.create().uv(132, 32).mirrored().cuboid(-3.8701F, -0.001F, -7.6039F, 8.0F, 11.0F, 0.0F, new Dilation(0.0F)).mirrored(false)
                ...
                .uv(62, 126).cuboid(-2.0907F, -7.001F, -5.7219F, 6.0F, 5.0F, 1.0F, new Dilation(0.001F))
                .uv(100, 98).cuboid(-2.7639F, -4.001F, -6.4879F, 7.0F, 6.0F, 1.0F, new Dilation(0.0F))
                .uv(119, 69).mirrored().cuboid(-3.8701F, -0.001F, -7.0039F, 8.0F, 11.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-0.0847F, 17.0397F, -0.0691F, -3.1416F, -1.0472F, 0.0F));
        ...
        ModelPartData cube_r3 = rotor_jodie.addChild("cube_r3", ModelPartBuilder.create().uv(74, 102).cuboid(-2.0907F, -7.001F, -5.0719F, 6.0F, 5.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(62, 126).cuboid(-2.0907F, -7.001F, -4.6719F, 6.0F, 5.0F, 1.0F, new Dilation(0.0F))
                .uv(99, 97).cuboid(-2.7639F, -3.001F, -5.6379F, 7.0F, 5.0F, 2.0F, new Dilation(0.0F))
                .uv(62, 113).cuboid(-3.8701F, 1.999F, -6.8539F, 8.0F, 9.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-0.0847F, 17.0397F, -0.0691F, 0.0F, -1.0472F, -3.1416F));
        ...
        ModelPartData cube_r4 = rotor_jodie.addChild("cube_r4", ModelPartBuilder.create().uv(74, 102).cuboid(-3.0F, -7.001F, -4.5469F, 6.0F, 6.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(99, 84).cuboid(-3.0F, -7.001F, -4.1469F, 6.0F, 6.0F, 1.0F, new Dilation(0.002F))
                .uv(123, 119).cuboid(-3.5F, -1.001F, -5.2129F, 7.0F, 5.0F, 2.0F, new Dilation(0.0F))
                .uv(63, 114).cuboid(-4.0F, 2.999F, -6.7789F, 8.0F, 8.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(-0.0847F, 17.0397F, -0.0691F, 0.0F, 0.0F, 3.1416F));
        ...
        ModelPartData cube_r5 = rotor_jodie.addChild("cube_r5", ModelPartBuilder.create().uv(130, 58).cuboid(-4.1299F, 0.999F, -7.0539F, 8.0F, 10.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(62, 126).cuboid(-3.9093F, -7.001F, -4.6719F, 6.0F, 5.0F, 1.0F, new Dilation(0.001F))
                .uv(123, 119).cuboid(-4.2361F, -2.001F, -5.6379F, 7.0F, 4.0F, 2.0F, new Dilation(0.0F))
                .uv(62, 113).cuboid(-4.1299F, 0.999F, -6.8539F, 8.0F, 10.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-0.0847F, 17.0397F, -0.0691F, 0.0F, 1.0472F, 3.1416F));
        ...
        ModelPartData cube_r6 = rotor_jodie.addChild("cube_r6", ModelPartBuilder.create().uv(74, 102).cuboid(-3.9093F, -7.001F, -6.1219F, 6.0F, 5.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(62, 126).cuboid(-3.9093F, -7.001F, -5.7219F, 6.0F, 5.0F, 1.0F, new Dilation(0.0F))
                .uv(124, 120).cuboid(-4.2361F, -4.001F, -6.4879F, 7.0F, 6.0F, 1.0F, new Dilation(0.0F))
                .uv(119, 69).cuboid(-4.1299F, -0.001F, -7.0039F, 8.0F, 11.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.0847F, 17.0397F, -0.0691F, -3.1416F, 1.0472F, 0.0F));
        ...
        ModelPartData cube_r8 = rotor_jodie.addChild("cube_r8", ModelPartBuilder.create().uv(62, 126).cuboid(-3.0F, -2.5F, -5.1969F, 6.0F, 5.0F, 1.0F, new Dilation(0.001F)), ModelTransform.of(-0.0847F, -22.4613F, -1.1191F, 0.0F, -2.0944F, 0.0F));
        ...
        ModelPartData cube_r11 = rotor_jodie.addChild("cube_r11", ModelPartBuilder.create().uv(62, 126).cuboid(-3.0F, -2.5F, -5.1969F, 6.0F, 5.0F, 1.0F, new Dilation(0.001F)), ModelTransform.of(-0.0847F, -22.4613F, -1.1191F, 0.0F, 1.0472F, 0.0F));
        ...
        ModelPartData cube_r14 = rotor_jodie.addChild("cube_r14", ModelPartBuilder.create().uv(99, 84).cuboid(-3.0F, -2.75F, -5.1969F, 6.0F, 6.0F, 1.0F, new Dilation(0.002F)), ModelTransform.of(-0.0847F, -22.2113F, -1.1191F, 0.0F, 3.1416F, 0.0F));
        ...
        ModelPartData cube_r26 = rotor_jodie.addChild("cube_r26", ModelPartBuilder.create().uv(109, 1).cuboid(-1.5577F, -9.5F, -6.0962F, 9.0F, 19.0F, 2.0F, new Dilation(0.001F)), ModelTransform.of(-0.0847F, 2.5387F, 3.6784F, 0.0F, 2.0944F, 0.0F));
        ...
        ModelPartData cube_r29 = rotor_jodie.addChild("cube_r29", ModelPartBuilder.create().uv(109, 1).cuboid(-7.4423F, -9.5F, -6.0962F, 9.0F, 19.0F, 2.0F, new Dilation(0.001F)), ModelTransform.of(-0.0847F, 2.5387F, 3.6784F, 0.0F, -2.0944F, 0.0F));
        ...
        ModelPartData cube_r30 = rotor_jodie.addChild("cube_r30", ModelPartBuilder.create().uv(132, 0).cuboid(-5.0F, -9.5F, -1.3F, 9.0F, 21.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(108, 0).cuboid(-5.0F, -9.5F, -0.5F, 9.0F, 21.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-6.1523F, 0.5387F, -3.7996F, 0.0F, 1.0472F, 0.0F));
        ...
        ModelPartData cube_r31 = rotor_jodie.addChild("cube_r31", ModelPartBuilder.create().uv(132, 0).cuboid(-5.0F, -9.5F, -1.6F, 9.0F, 21.0F, 0.0F, new Dilation(0.0F))
                ...
                .uv(0, 128).cuboid(-5.0F, -9.5F, -0.7F, 9.0F, 21.0F, 0.0F, new Dilation(0.0F))
                .uv(108, 0).cuboid(-5.0F, -9.5F, -0.5F, 9.0F, 21.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(6.483F, 0.5387F, -2.9335F, 0.0F, -1.0472F, 0.0F));
