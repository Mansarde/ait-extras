...
public class EctoExteriorModel extends ExteriorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		.uv(28, 305).cuboid(-14.0F, -71.0F, -19.0F, 28.0F, 5.0F, 4.0F, new Dilation(0.0F))
		...
		.uv(0, 0).cuboid(-3.0F, -78.0F, -3.0F, 6.0F, 3.0F, 6.0F, new Dilation(0.0F))
		.uv(0, 374).cuboid(-4.0F, -75.0F, -4.0F, 8.0F, 5.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.0F, 0.0F));

		ModelPartData cube_r9 = Roof.addChild("cube_r9", ModelPartBuilder.create().uv(0, 18).cuboid(-2.0F, -71.75F, -2.0F, 4.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -11.25F, 0.0F, 0.0F, 0.7854F, 0.0F));

		ModelPartData cube_r10 = Roof.addChild("cube_r10", ModelPartBuilder.create().uv(80, 333).cuboid(-3.0F, -2.0F, -1.0F, 6.0F, 5.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(-9.0F, -79.0F, 2.0F, 0.0F, 1.5708F, 0.0F));
		...
		ModelPartData cube_r12 = Roof.addChild("cube_r12", ModelPartBuilder.create().uv(80, 333).mirrored().cuboid(-3.0F, -2.0F, -1.0F, 6.0F, 5.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(9.0F, -79.0F, 2.0F, 0.0F, -1.5708F, 0.0F));
		...
		.uv(51, 324).mirrored().cuboid(-2.0F, -2.0F, -1.25F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(11.0F, -75.0F, -14.75F, 0.0F, 0.0F, 0.7854F));

		ModelPartData cube_r15 = Roof.addChild("cube_r15", ModelPartBuilder.create().uv(51, 324).cuboid(-2.0F, -2.0F, -1.25F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
