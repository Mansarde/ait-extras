...
public class HatStandOakRenderer<T extends HatStandOakBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public static final Identifier HAT_STAND_TEXTURE = new Identifier(AITExtras.MOD_ID,
    ...
    public void render(T entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        this.hatStandModel.render(matrices,
                vertexConsumers.getBuffer(RenderLayer.getEntityTranslucent(HAT_STAND_TEXTURE)), light, overlay, 1.0F,
                1.0F, 1.0F, 1.0F);
