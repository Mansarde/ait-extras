...
public class AITExtrasModelProvider extends AmbleModelProvider {
    ...
    public AITExtrasModelProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generateItemModels(ItemModelGenerator generator) {
        ...
        this.withItems(AITExtrasItems.class);
        this.withBlocks(AITExtrasBlocks.class);
